...
- End-to-end data projects with SQL + Python + interactive dashboards
- Applied statistics for real-world public datasets (CMS, open government data)
- Time-series forecasting and count regression models
